...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
        sa.CheckConstraint(
            "(session_id IS NOT NULL AND session_group_id IS NULL) OR (session_id IS NULL AND session_group_id IS NOT NULL)",
            name="check_session_xor_group",
        ),
        sa.ForeignKeyConstraint(
            ["exercise_template_id"], ["exercise_templates.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(["session_group_id"], ["session_groups.id"], ondelete="CASCADE"),
