...
describe('SessionModal', () => {
    const mockClients: Client[] = [
        { id: 1, name: 'Ana García', email: 'ana@test.com', phone: '1234567890', status: 'active', created_at: '', updated_at: '' },
        { id: 2, name: 'Carlos Rodríguez', email: 'carlos@test.com', phone: '0987654321', status: 'active', created_at: '', updated_at: '' },
    ];
    ...
    it('displays multiple clients in view mode', () => {
        const groupSessions: TrainingSession[] = [
            {
                id: 1, trainer_id: 1, client_id: 1, scheduled_at: '2026-02-04T10:00:00', duration_minutes: 60, status: 'scheduled',
                created_at: '', updated_at: '', session_group_id: 100, location_id: null, notes: null, is_paid: false, paid_at: null
            } as TrainingSession,
            {
                id: 2, trainer_id: 1, client_id: 2, scheduled_at: '2026-02-04T10:00:00', duration_minutes: 60, status: 'scheduled',
                created_at: '', updated_at: '', session_group_id: 100, location_id: null, notes: null, is_paid: false, paid_at: null
            } as TrainingSession
        ];
