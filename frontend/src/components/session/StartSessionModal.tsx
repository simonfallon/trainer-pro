            ...
            <div className="modal" onClick={(e) => e.stopPropagation()}>
                ...
                <form onSubmit={handleSubmit}>
                    <div className="form-group">
                        <label className="form-label" htmlFor="sessionClient">Seleccionar Clientes *</label>
                    ...
                    <div className="form-group">
                        <label className="form-label" htmlFor="sessionDuration">Duración</label>
                        <select
                            id="sessionDuration"
                            className="form-select"
                    ...
                    <div className="form-group">
                        <label className="form-label" htmlFor="sessionLocation">Ubicación</label>
                        <select
                            id="sessionLocation"
                            className="form-select"
